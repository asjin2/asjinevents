    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          {/* Services */}
          <div>
            <h3 className="font-semibold text-base sm:text-lg mb-4">Our Services</h3>
            <ul className="space-y-2">
              {services.map((service, index) => (
                <li key={index}>
                  <span className="text-sm sm:text-base text-gray-300 hover:text-purple-400 transition-colors duration-300">
                    {service}
                  </span>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <a href="tel:+918903821128" className="text-sm sm:text-base text-gray-300 hover:text-purple-400 transition-colors duration-300">
                  +91 8903821128
                </a>
              </div>
            ...
            <div className="mt-4">
              ...
              <p className="text-sm sm:text-base text-gray-300">9:00 AM - 8:00 PM (Daily)</p>
            </div>
          </div>
        </div>
