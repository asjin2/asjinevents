...
function Blog() {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      image: 'https://res.cloudinary.com/dszxkjpev/image/upload/v1756318968/wed_7_tt1kkc.jpg',
      author: 'Asjin Events Team',
      date: '2023-12-28',
      readTime: '8 min',
    ...
    },
    {
      ...
      image: 'https://res.cloudinary.com/dszxkjpev/image/upload/v1756318968/wed_1_nym1sx.jpg',
      author: 'Asjin Events Team',
      date: '2023-12-20',
      readTime: '4 min',
    ...
    },
    {
      ...
      image: 'https://res.cloudinary.com/dszxkjpev/image/upload/v1756318962/wed_5_kgze6b.jpg',
      author: 'Asjin Events Team',
      date: '2023-12-15',
      readTime: '6 min',
      ...
      <section className="py-16 bg-purple-600 text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-md mx-auto flex gap-4">
            ...
            />
            <button className="bg-white text-purple-600 px-6 py-3 rounded-full font-medium hover:bg-gray-100 transition-colors duration-300">
              Subscribe
            </button>
          </div>
        </div>
